({
    Croppie: function(cmp) {
        //console.log('hello from Croppie'+$A.get('$Resource.Croppie'));
        //$('#my-image').croppie();
    ...
    Toggle: function(cmp, ev) {
        ...
        // Croppie is dependent on it's container being visible when the bind method is called. 
        // This can be an issue when your croppie component is inside a modal that isn't shown. Let's take the bootstrap modal for example..
        // If you are having issues getting the correct crop result, and your croppie instance is shown inside of a modal, try taking your croppie out of the modal 
        // and see if your issues persist. If they don't, then make sure that your bind method is called after the modal is done animating.
        // Donc nous ne devons initialiser l'outil uniquement quand on affiche la fenetre et non pas dans l'initialisation (c.doInit) !!
